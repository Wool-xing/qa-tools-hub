import{E as e,H as t,O as n,P as r,c as i,d as a,ft as o,i as s,m as c,mt as l,p as u,pt as ee,s as d,t as te,u as f}from"./_plugin-vue_export-helper-Dx7e6khD.js";import{f as p,i as ne}from"./index-CCyGxejk.js";var re={class:`lab-page`},ie={class:`perf-layout`},ae={class:`perf-left`},oe={class:`card`,style:{"margin-bottom":`var(--space-md)`}},se={class:`template-bar`},ce=[`onClick`],le={class:`slider-group`},m={class:`slider-label`},h={class:`slider-group`},g={class:`slider-label`},_=[`disabled`],v={key:0,class:`spinner`},y={class:`perf-right`},b={key:0,class:`card empty-state`},x={key:1,class:`card`,style:{"text-align":`center`,padding:`32px`,color:`var(--text-secondary)`}},S={key:2,class:`results-panel`},C={class:`stat-grid`},w={class:`stat-card`},T={class:`stat-num`},E={class:`stat-num`},D={class:`stat-card`},O={class:`stat-num`},k={class:`stat-card`},A={class:`stat-num`},j={class:`card`,style:{"margin-bottom":`var(--space-md)`,padding:`12px 16px`}},M={class:`endpoint-info`},N={class:`ep-path`},P={class:`ep-meta`},F={class:`card`,style:{"margin-bottom":`var(--space-md)`}},I={class:`latency-bars`},L={class:`lat-key`},ue={class:`lat-bar-track`},R={class:`lat-val`},z={class:`card`,style:{"margin-bottom":`var(--space-md)`}},B={class:`timeline-chart`},V=[`viewBox`],H=[`y1`,`y2`],U=[`points`],de=[`points`],fe=[`points`],pe={class:`card`},me={class:`checks-row`},W=580,G=160,K=te({__name:`PerformanceLabView`,setup(te){let K=t(`import http from 'k6/http';
