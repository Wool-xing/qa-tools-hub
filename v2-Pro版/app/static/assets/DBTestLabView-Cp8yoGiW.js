import{B as e,E as t,M as n,ft as r,i,l as a,p as o,s,t as c,u as l,ut as u,w as d}from"./_plugin-vue_export-helper-DXz6b_sJ.js";import{d as f,r as p}from"./index-Bv8412cT.js";var m={class:`lab-page`},h={class:`challenge-bar`},g=[`onClick`],_={key:0,class:`card`,style:{"margin-bottom":`var(--space-md)`}},v={class:`ch-header`},y={class:`tag tag-warning`},b={class:`ch-task-text`},x={class:`schema-details`},S={class:`schema-pre`},C={style:{"margin-top":`12px`}},w=[`placeholder`],T={class:`toolbar`},E={style:{display:`flex`,gap:`8px`}},D=[`disabled`],O={key:0,class:`info-box`},k={key:1,class:`solution-box`},A={class:`solution-code`},j={key:1,class:`card`,style:{"text-align":`center`,padding:`32px`,color:`var(--text-secondary)`}},M={key:2,class:`card`,style:{overflow:`hidden`,padding:`0`}},N={key:0},P={style:{padding:`12px 20px`,"font-size":`.78rem`,color:`var(--text-secondary)`,"border-bottom":`1px solid var(--border)`}},F={key:0,style:{"margin-left":`12px`,color:`var(--text-muted)`}},I={style:{"overflow-x":`auto`}},L={key:0,class:`result-table`},R={key:0,style:{padding:`32px`,"text-align":`center`,color:`var(--text-muted)`}},z={key:1,style:{padding:`16px 20px`,color:`var(--danger)`,background:`var(--danger-light)`,"font-size":`.84rem`}},B=c({__name:`DBTestLabView`,setup(c){let B=e(``),V=e(null),H=e(!1),U=e(!1),W=e(!1),G=e(0),K=e([!1,!1,!1]),q=[{diff:`⭐⭐`,label:`JOINs 数据校验`,domain:`数据完整性`,task:`找出所有订单中 payment 金额与 order total 不一致的记录。这是一个数据完整性检查——确保每笔支付金额与订单金额匹配。`,placeholder:`-- 连接 orders 和 payments 表，比较 total 和 amount
