import{B as e,E as t,M as n,dt as r,f as i,ft as a,i as o,l as s,o as c,p as l,s as u,t as ee,u as d,ut as f,w as p}from"./_plugin-vue_export-helper-DXz6b_sJ.js";import{d as m,r as te}from"./index-Bv8412cT.js";var ne={class:`lab-page`},re={class:`perf-layout`},ie={class:`perf-left`},ae={class:`card`,style:{"margin-bottom":`var(--space-md)`}},oe={class:`template-bar`},se=[`onClick`],ce={class:`slider-group`},le={class:`slider-label`},h={class:`slider-group`},g={class:`slider-label`},_=[`disabled`],v={key:0,class:`spinner`},y={class:`perf-right`},b={key:0,class:`card empty-state`},x={key:1,class:`card`,style:{"text-align":`center`,padding:`32px`,color:`var(--text-secondary)`}},S={key:2,class:`results-panel`},C={class:`stat-grid`},w={class:`stat-card`},T={class:`stat-num`},E={class:`stat-num`},D={class:`stat-card`},O={class:`stat-num`},k={class:`stat-card`},A={class:`stat-num`},j={class:`card`,style:{"margin-bottom":`var(--space-md)`,padding:`12px 16px`}},M={class:`endpoint-info`},N={class:`ep-path`},P={class:`ep-meta`},F={class:`card`,style:{"margin-bottom":`var(--space-md)`}},I={class:`latency-bars`},L={class:`lat-key`},R={class:`lat-bar-track`},ue={class:`lat-val`},z={class:`card`,style:{"margin-bottom":`var(--space-md)`}},B={class:`timeline-chart`},V=[`viewBox`],H=[`y1`,`y2`],U=[`points`],de=[`points`],fe=[`points`],pe={class:`card`},me={class:`checks-row`},W=580,G=160,K=ee({__name:`PerformanceLabView`,setup(ee){let K=e(`import http from 'k6/http';
