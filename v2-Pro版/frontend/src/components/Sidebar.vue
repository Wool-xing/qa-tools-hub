...
const sections = [
  {
    ...
    items: [
      ...
      { to: '/labs', icon: '🧪', label: '实验室', match: 'labs' },
      { to: '/testcases', icon: '📋', label: '用例库', match: 'testcases' },
      { to: '/teams', icon: '👥', label: '团队协作', match: 'teams' },
    ],
  },
  {
    key: 'levels',
    ...
    items: [
      ...
      { to: '/levels', icon: '📡', label: 'API测试', badge: '3关' },
      { to: '/levels', icon: '📱', label: 'APP测试', badge: '4关' },
      { to: '/levels', icon: '⚡', label: '性能测试', badge: '3关' },
      { to: '/levels', icon: '🛡️', label: '安全测试', badge: '4关' },
      { to: '/levels', icon: '📶', label: '网络&抓包', badge: '3关' },
      { to: '/levels', icon: '🖥️', label: '运维&数据库', badge: '3关' },
    ],
  },
  {
    key: 'labs',
    ...
    items: [
      ...
      { to: '/labs/api', icon: '📮', label: 'API 请求练习', match: 'api-lab' },
      { to: '/labs/network', icon: '📶', label: '网络协议', match: 'network-lab' },
      { to: '/labs/xpath', icon: '🎯', label: 'XPath/CSS', match: 'xpath-lab' },
      { to: '/labs/security', icon: '🛡️', label: '安全靶场', match: 'security-lab' },
      { to: '/labs/performance', icon: '📈', label: '性能测试', match: 'performance-lab' },
      { to: '/labs/ai', icon: '🤖', label: 'AI 测试', match: 'ai-lab' },
      { to: '/labs/cicd', icon: '🔄', label: 'CI/CD管道', match: 'cicd-lab' },
      { to: '/labs/automation', icon: '🤖', label: '自动化测试', match: 'automation-lab' },
      { to: '/labs/mock', icon: '🎭', label: 'API虚拟化', match: 'mock-lab' },
      { to: '/labs/datagen', icon: '🎲', label: '数据生成', match: 'datagen-lab' },
    ],
  },
  {
    key: 'practice',
    ...
    items: [
      ...
      { to: '/labs/exploratory', icon: '🗺️', label: '探索式测试', match: 'exploratory-lab' },
      { to: '/labs/requirements', icon: '📋', label: '需求分析', match: 'requirements-lab' },
      { to: '/labs/mutation', icon: '🧬', label: '变异测试', match: 'mutation-lab' },
      { to: '/labs/visual', icon: '🔍', label: '视觉回归', match: 'visual-lab' },
      { to: '/labs/dbtest', icon: '🗄️', label: '数据库测试', match: 'dbtest-lab' },
      { to: '/labs/mobile', icon: '📱', label: '移动测试', match: 'mobile-lab' },
      { to: '/labs/devtools', icon: '🔧', label: 'DevTools', match: 'devtools-lab' },
    ],
  },
]
