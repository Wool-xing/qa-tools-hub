...
const sections = [
  ...
  },
  {
    ...
    label: '能力进阶',
    items: [
      { to: '/levels?stage=beginner', label: '入门', match: false, badge: '8关' },
      { to: '/levels?stage=intermediate', label: '进阶', match: false, badge: '3关' },
      { to: '/levels?stage=advanced', label: '专家', match: false, badge: '4关' },
    ],
  },
  {
    key: 'domains',
    label: '专项领域',
    items: [
      { to: '/levels?stage=web', label: 'Web测试', match: false, badge: '4关' },
      { to: '/levels?stage=api', label: 'API测试', match: false, badge: '3关' },
      { to: '/levels?stage=mobile', label: 'APP测试', match: false, badge: '4关' },
      { to: '/levels?stage=performance', label: '性能测试', match: false, badge: '3关' },
      { to: '/levels?stage=security', label: '安全测试', match: false, badge: '4关' },
      { to: '/levels?stage=network', label: '网络&抓包', match: false, badge: '3关' },
      { to: '/levels?stage=ops', label: '运维&数据库', match: false, badge: '3关' },
      { to: '/levels?stage=cicd', label: 'CI/CD', match: false, badge: '2关' },
      { to: '/levels?stage=automotive', label: '车载测试', match: false, badge: '2关' },
      { to: '/levels?stage=accessibility', label: '无障碍测试', match: false, badge: '3关' },
      { to: '/levels?stage=data', label: '数据测试', match: false, badge: '3关' },
      { to: '/levels?stage=chaos', label: '混沌工程', match: false, badge: '3关' },
      { to: '/levels?stage=visual', label: '视觉回归', match: false, badge: '3关' },
      { to: '/levels?stage=risk', label: '风险驱动', match: false, badge: '3关' },
      { to: '/levels?stage=metrics', label: '质量度量', match: false, badge: '4关' },
      { to: '/levels?stage=automation-arch', label: '自动化架构', match: false, badge: '4关' },
      { to: '/levels?stage=advanced-api', label: '现代API', match: false, badge: '3关' },
      { to: '/levels?stage=compliance', label: '合规测试', match: false, badge: '3关' },
      { to: '/levels?stage=fintech', label: '金融测试', match: false, badge: '4关' },
    ],
  },
  {
    key: 'labs',
